...
| ------------------| ----------- | ------------ | ------------ | ------------- | ----------------- | ------------------ |
| s1-brdr1 | 52 | 48 | 0 | 4 | - | Hardware |
| s1-brdr2 | 52 | 48 | 0 | 4 | - | Hardware |
| s1-leaf1 | 53 | 49 | 0 | 4 | - | Hardware |
| s1-leaf2 | 53 | 49 | 0 | 4 | - | Hardware |
| s1-leaf3 | 53 | 49 | 0 | 4 | - | Hardware |
| s1-leaf4 | 53 | 49 | 0 | 4 | - | Hardware |
| s1-spine1 | 38 | 34 | 0 | 4 | - | Hardware |
| s1-spine2 | 38 | 34 | 0 | 4 | - | Hardware |
...
| 52 | s1-brdr1 | System | VerifyReloadCause | Verifies the last reload cause of the device. | - | PASS | - |
...
| 104 | s1-brdr2 | System | VerifyReloadCause | Verifies the last reload cause of the device. | - | PASS | - |
...
| 157 | s1-leaf1 | System | VerifyReloadCause | Verifies the last reload cause of the device. | - | PASS | - |
...
| 210 | s1-leaf2 | System | VerifyReloadCause | Verifies the last reload cause of the device. | - | PASS | - |
...
| 263 | s1-leaf3 | System | VerifyReloadCause | Verifies the last reload cause of the device. | - | PASS | - |
...
| 316 | s1-leaf4 | System | VerifyReloadCause | Verifies the last reload cause of the device. | - | PASS | - |
...
| 354 | s1-spine1 | System | VerifyReloadCause | Verifies the last reload cause of the device. | - | PASS | - |
...
| 392 | s1-spine2 | System | VerifyReloadCause | Verifies the last reload cause of the device. | - | PASS | - |
